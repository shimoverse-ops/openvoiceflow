...
app (v0.5.21). Where behaviour is surprising, say so plainly rather than
...
PAGES["index"] = {
    ...
    "lede": "Everything about running OpenVoiceFlow on your Mac — from first launch to the exact bytes that do and don't leave your machine. Written against the shipping app, version 0.5.21.",
    "body": """
        ...
        <p>An honest manual saves you the trouble of looking for something that isn't there. As of 0.5.21:</p>
        <ul>
...
PAGES["faq"] = {
    ...
    "faq": [
        ...
        ("Can I say punctuation out loud?",
         "Not in version 0.5.21 — saying 'comma' produces the word 'comma'. Whisper punctuates from sentence structure automatically, and optional AI cleanup fixes grammar and removes filler words if you want more."),
